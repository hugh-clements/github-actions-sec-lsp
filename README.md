...
This is a Language server developed to identify security vulnerabilities inside GitHub workflow files. It is used as part of a VSCode extension, found [here](https://github.com/hugh-clements/github-actions-vscode-extension).

## Usage
The language server adheres to the LSP spec and uses stdio for communication. It can be used with any client or IDE that supports this, however, it is built to be used through the VSCode [extension](https://marketplace.visualstudio.com/items?itemName=Hugh-Clements.github-actions-workflow-security-scanner)
